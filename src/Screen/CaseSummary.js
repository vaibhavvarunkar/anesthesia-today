        ...
        <div  >
            ...
            <div className="all-action-container" >
                <div className="tab-parent-wrapper">
                    <div className="tab-container case" >
                                ...
                                {optionsforage.map((data) => {
                                    if (data.value === ageType) {
                                        ...
                                        return (
                                            ...
                                            <button type="button" className="btn btn-primary" onClick={() => handleChangeAgeTpe(data)}>{data.label}</button>
                                        )
                                    } else {
                ...
                {questinNo == 7 ?
                    <div className="question-container" >
                        ...
                        <div className="medication-extra-type-container" >
                            ...
                            <div className="add-more-button" onClick={() => addotherIntoSurgeryTypeCategory(categoryValue)} ><i className="fa fa-plus-circle">&nbsp;&nbsp;</i>Add</div>
                        </div>
                        {
                            otherSurgeryTypeArray.map((data) => {
                                return (
                ...
                {questinNo == 11 ?
                    <div className="question-container" >
                        ...
                        <div className="medication-extra-type-container" >
                            <input className="medication-input" onChange={(e) => setcategoryValue(e.target.value)} placeholder="enter not listed type" />
                            <div className="add-more-button" onClick={() => addotherIntoSurgeryHistoryCategory(categoryValue)} ><i className="fa fa-plus-circle">&nbsp;&nbsp;</i>Add</div>
                        </div>
                        {
                ...
                {questinNo == 13 ?
                    <div className="question-container" >
                        ...
                        <div className="ANESTHESIA-type-input-container" >
                            ...
                            <div className="medication-extra-type-container" >
                                <input className="medication-input" onChange={(e) => setcategoryValue(e.target.value)} placeholder="enter not listed type" />
                                <div className="add-more-button" onClick={() => addotherIntoAllgriesCategory(categoryValue)} ><i className="fa fa-plus-circle">&nbsp;&nbsp;</i>Add</div>
                            </div>
                            {
                                otherAllegriesArray.map((data) => {
                                    return (
                ...
                {questinNo == 14 ?
                    <div className="question-container" >
                        ...
                        <div className="text-center">Ingested material</div>
